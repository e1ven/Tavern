...
class DiskTopics(object):
    ...
    def writetopic(self,topic,since=0,limit=100,skip=0):
        ...
        for envelope in server.mongos['unsafe']['envelopes'].find({'envelope.local.time_added': {'$gt' : since },'envelope.payload.topic' : topic },limit=limit,skip=skip,as_class=OrderedDict):
