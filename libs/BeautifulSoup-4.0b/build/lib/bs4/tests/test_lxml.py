...
class TestLXMLBuilder(SoupTest):
    ...
    def test_literal_in_textarea(self):
        ...
        self.assertEquals(soup.textarea.contents[0], "Junk like ")
        self.assertEquals(soup.textarea.contents[1].name, 'b')
        self.assertEquals(soup.textarea.b.string, " tags and ")
    ...
    def test_non_breaking_spaces_converted_on_the_way_in(self):
        soup = self.soup("<a>&nbsp;&nbsp;</a>")
        self.assertEquals(soup.a.string, "\N{NO-BREAK SPACE}" * 2)
...
class TestLXMLBuilderEncodingConversion(SoupTest):
    ...
    def test_unicode_in_unicode_out(self):
        ...
        self.assertEquals(soup_from_unicode.foo.string, 'Sacr\xe9 bleu!')
    ...
    def test_utf8_in_unicode_out(self):
        ...
        self.assertEquals(soup_from_utf8.foo.string, 'Sacr\xe9 bleu!')
